...
import {postData, getSiteData, getPageData, getTemplates, getPages, postPage, getUsers, postUser} from './api';
...
async function start(port, siteName)
{
    ...
    function serveSite(PAGES, SITEDATA, FX) {
      ...
      app.post('/api/user/:username', postPage(app, SITEDATA.site, SITEDATA.templates, FX, PAGES, resetServer));
